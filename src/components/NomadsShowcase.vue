  ...
  <section class="nomads-showcase-section">
    <div class="showcase-header">
      <div class="header-left">
        <h2 class="showcase-title">学术论文大纲与写作指导专家实战模板库</h2>
...
const showcaseItems = computed<ShowcaseItem[]>(() => [
  {
    id: 'ai-lunwen-1',
    tag: '计算机论文',
    title: '深度学习图像分割硕士论文大纲',
    prompt: '构建计算机硕士论文《基于改进 UNet 的医学图像分割算法研究》三级大纲与实验方案。',
    usageCount: '54.9k'
  },
  {
    id: 'ai-lunwen-2',
    tag: '经管论文',
    title: '数字金融对中小企业融资实证论文',
    prompt: '设计商科毕业论文《数字金融发展对中小企业融资约束的影响实证研究》五章架构。',
    usageCount: '48.3k'
  },
  {
    id: 'ai-lunwen-3',
    tag: '社科论文',
    title: '新媒体短视频沉浸体验论文框架',
    prompt: '撰写新闻传播学论文《短视频平台算法推荐对青年群体沉浸体验的影响研究》大纲。',
    usageCount: '42.6k'
  },
  {
    id: 'ai-lunwen-4',
    tag: '论文降重',
    title: '学术论文重复率超标改写降重指南',
    prompt: '提供 5 种学术论文高频重复句式的重构与同义替换技巧，保持学术严谨性。',
    usageCount: '38.1k'
  },
  {
    id: 'ai-lunwen-5',
    tag: '期刊论文',
    title: 'CSSCI 核心期刊论文框架与写作范式',
    prompt: '为社会学论文构建符合 CSSCI 期刊要求的摘要、引言、理论假设与结论框架。',
    usageCount: '33.9k'
  },
  {
    id: 'ai-lunwen-6',
    tag: '医学论文',
    title: '临床医学回顾性分析论文写作结构',
    prompt: '设计临床医学论文《120 例急性心肌梗死患者预后影响因素分析》文献与讨论架构。',
    usageCount: '30.1k'
  }
]);
