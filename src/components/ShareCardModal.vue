    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">论文写作与学术开题</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 论文写作与学术大纲助手</span>
...
// 清理回复末尾的特殊标记 [LUNWEN_SCORES]...[/LUNWEN_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[LUNWEN_SCORES\][\s\S]*?\[\/LUNWEN_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 论文写作与学术大纲生成专家】\n\n${cleanContent.value}\n\n体验学术大纲AI助手：https://ai.wuxian.xyz`;
